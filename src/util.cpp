...
const char * const BITCOIN_CONF_FILENAME = "wsacoin.conf";
const char * const BITCOIN_PID_FILENAME = "wsacoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "WSACoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/WSACoin";
#else
    // Unix
    return pathRet / ".wsacoin";
#endif
#endif
}
