...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s wsacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  wsacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wsacoin transaction") + "\n" +
              "  wsacoin-tx [options] -create [commands]   " + _("Create hex-encoded wsacoin transaction") + "\n" +
              "\n";
