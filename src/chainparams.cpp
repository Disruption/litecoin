...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.wsacoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.wsacointools.com", true);
        vSeeds.emplace_back("dnsseed.wsacoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.wsacointools.com", true);
        vSeeds.emplace_back("seed-b.wsacoin.loshan.co.uk", true);
